...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/attendance-ops', name: 'attendance-ops', meta: { roles: ['admin', 'manager', 'employee'] }, component: () => import('@/views/AttendanceOpsView') },
    { path: '/settings', name: 'settings', meta: { roles: ['admin'] }, component: () => import('@/views/SettingsView') },
    { path: '/account', name: 'account', meta: { roles: ['admin', 'manager', 'employee'] }, component: () => import('@/views/AccountSettingsView') },
